  ...
  { imageUrl: DDIcon, 
    ...
    data: {
      ...
      descriptions: [
        ...
        'We can’t wait for you to experience Daily Disc and join our community of disc-throwing adventurers! Download it today on the App Store and start your journey to mastering the disc. Don’t forget to invite your friends to play and see who can become the daily disc master! Stay tuned for more updates, including special events and new features we’ll be rolling out soon. Every day is a new adventure in Daily Disc—are you ready to take on the challenge?',
      ],
      subtitles: [
        'What is Daily Disc?',
        'Key Features',
